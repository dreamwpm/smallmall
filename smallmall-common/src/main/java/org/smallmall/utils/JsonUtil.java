...
public final class JsonUtil {
	 ...
	 *
	 * @param BO/VO,map,数组,list
	 *            对象
	 * @return JSON字符串
	 * @说明：对bean中有Date类型的数据可以成功转换成yyyy-MM-dd HH:mm:ss格式的时间类型,例如："barDate":yyyy-
	 *                                       MM-dd HH:mm:ss
	 */
	 ...
	 * @param BO/VO,map,数组,list
	 *            对象
	 * @return JSON字符串 @说明：对bean中有Date类型的数据可以成功转换成long格式的时间类型,例如："barDate":
	 *         1458268099098
	 */
	 ...
	 *            JSON数组数据
	 * @param calzz
	 *            待转换的Bean类型 --LinkedCaseInsensitiveMap
	 * @return
	 */
